...
public class Valor {
    ...
    public Valor(String nombreValor, String variablePadre){
    ...
    public void calcularIndiceGini(){
        ...
        /*System.out.println("nodoSi_cant0: "+nodoSi_cant0+" nodoSi_cant1 "+nodoSi_cant1
        + " nodoNo_cant0: "+nodoNo_cant0+" nodoNo_cant1: "+nodoNo_cant1);
        
        this.indiceGini = igPon;
        
        System.out.println( "nombre: "+  this.nombreValor +  " p0Si: "+p0Si+" p1Si: " +p1Si+ " p0No: "+p0No+" p1No "+p1No);*/
