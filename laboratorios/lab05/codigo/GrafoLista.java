...
public class GrafoLista {
    ...
    private boolean agregarArcoAux(Vertice indiceEtiqueta, int verticePartida) {
    ...
    public boolean agregarArco(int etiqueta, int verticePartida, int verticeLlegada) {
        if(agregarArcoAux(new Vertice(verticeLlegada, etiqueta), verticePartida)){
            numArcos+=1;
            return true;
        }
        return false;
    ...
    public ArrayList<Integer> obtenerVerticesAsociados(int valorPartida) {
